...
public class DoctorDetailsActiviy extends AppCompatActivity {
    private String[][] doctor_details1=
            {
                    {"Doctor Name: Ajit Saste","Hospital Address : Pimpri","Exp : 5yrs","Mobile No : 9898989898","600"},
                    {"Doctor Name: Prasad Pawar","Hospital Address : Nigdi","Exp : 15yrs","Mobile No : 78989898","900"},
    ...
    private String[][] doctor_details2=
            {
                    ...
                    {"Doctor Name: Minakashi Panda","Hospital Address : Katrai","Exp : 7yrs","Mobile No : 7798989898","800"}
            };
    private String[][] doctor_details3=
            {
                    ...
                    {"Doctor Name: Monih Jain","Hospital Address : Pune","Exp : 7yrs","Mobile No : 8898989898","300"},
    ...
    private String[][] doctor_details5=
            {
                    ...
                    {"Doctor Name: Pankai Pawar","Hospital Address : Nigdi","Exp : 15yrs","Mobile No : 7898989898","1900"},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_details_activiy);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DoctorDetailsActiviy.this,FindDoctorActivity.class));
            }
        });
        list =new ArrayList();
        ...
        ListView lst =findViewById(R.id.listVievDD);
        lst.setAdapter(sa);
